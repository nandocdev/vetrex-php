...
$query=mysqli_query($conn,"SELECT `id`,`date`,`patient`,`description`FROM addmedicalhistory")or die (mysqli_error($db_connect));
$numrows=mysqli_num_rows($query)or die (mysqli_error($db_connect));


$columnHeader ='';
$columnHeader = "Sr.no"."\t"."Date"."\t"."Patient"."\t"."Description"."\t";
