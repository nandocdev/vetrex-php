...
$query=mysqli_query($conn,"UPDATE addpayment SET invoice='$invoice',subtotal='$subtotal',depositammount='$depositammount',date='$d1' WHERE id='".$_GET['id']."'") or die(mysqli_error($db_connect));
