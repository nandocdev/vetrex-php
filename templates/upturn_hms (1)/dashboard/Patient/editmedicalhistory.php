...
<?php 
  ...
  $w =mysqli_query($conn,$sql) or die(mysqli_error($db_connect));
 // print_r($sql); exit;
...
//echo "string"; exit();
    ...
    $write =mysqli_query($conn,"UPDATE addmedicalhistory SET date='$date',patient='$patient',description='$description' WHERE id='".$_GET['id']."'") or die(mysqli_error());
